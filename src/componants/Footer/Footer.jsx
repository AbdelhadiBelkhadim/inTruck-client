    ...
    <div className='container'>
        <div className='flex flex-col justify-between md:flex-row items-start gap-5 py-10'>
            <div className='my-10'>
                ...
                <MdOutlineEmail className='w-[21px] h-[21px]'/>
                <p className='text-[14px]'>inTruck@inTruck.ma</p>
                </div>

                <div className='flex gap-3 mb-2'>
                <FaPhoneAlt className='w-[21px] h-[21px]'/>
            ...
            <div className='my-8 '>
                <div className='flex justify-between gap-10 lg:gap-20'>
                  <div className='text-[11px] md:text-[14px]'>
                    <h3 className='text-primary font-semibold md:text-[14px] mb-3'>Service</h3>
                  ...
                  <div className='text-[11px] md:text-[14px]'>
                    <h3 className='text-primary font-semibold mb-3'>Our Social Media</h3>
                    <ul className='space-y-2'>
                      <li><a>Facebook</a></li>
                      <li><a>Instagram</a></li>
                      <li><a>Tiwtter</a></li>
            ...
            <div className='flex flex-col items-start'>
              ...
              <input placeholder='Enter your email' className='p-4 border-1 w-[263px] h-[49px] my-5'/>
              <button className='bg-primary p-4 rounded-2xl w-[128px] h-[53px] text-white font-semibold'>Send</button>
            </div>
