...
const SideBar = ({setOpen, open}) => {
  return (
    <aside className={`space-y-1 ${open ? 'w-fit' : 'w-fit'} mb-4 overflow-y-auto scrollbar-hide py-2`}>
            <div className={`space-y-2 ${open ? 'w-60' : 'w-24'}`}>
              ...
              <Link to="/profile" className={`flex items-center`}>
                <div className={`relative flex items-center justify-between py-1 px-4 h-[85px] bg-white rounded-[14px] ${open ? 'w-60' : 'w-24'}`}>
              ...
              {/* Navigation */}
              <nav className={`mb-4 bg-white p-4 rounded-xl ${open ? 'w-60' : 'w-24'}`}>
