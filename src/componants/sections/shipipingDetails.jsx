...
const ShippingDetails = ({ count, data = {} }) => {
  const { statusCounts = {}, statusPercentages = {} } = data;
          ...
          <div className=''>
            ...
            <div className="mt-2 space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span>{statusCounts.IN_TRANSIT || 0} ({statusPercentages.IN_TRANSIT || '0%'})</span>
              </div>
              <div className="flex justify-between text-sm">
                <span>Delivered:</span>
                <span>{statusCounts.DELIVERED || 0} ({statusPercentages.DELIVERED || '0%'})</span>
              </div>
            </div>
          </div>
        </div>
